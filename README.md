...
A fictional social-services agency's Refugee Status Determination (RSD) workflow, modelled as a realistic synthetic dataset designed to drive portfolio-grade BI and Data Engineering projects, while ensuring no real individual, case, or operational record can be identified or reconstructed from it.
